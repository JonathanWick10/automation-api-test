import { LATEST_JOB_DATA_SCHEMA_VERSION, QueueName, RepeatableJobType, ScheduledJobData } from 'automation-server-shared-test'
import { apId, ExecutionType, isNil, RunEnvironment, TriggerStrategy } from 'automation-shared-test'
import { Job, RepeatableJob, JobSchedulerJson  } from 'bullmq'
...
async function updateLegacyRepeatableJobKey(repeatableJobs: JobSchedulerJson[], log: FastifyBaseLogger) {
    log.info({
...
async function getLegacyRepeatableJobs(): Promise<JobSchedulerJson[]> {
