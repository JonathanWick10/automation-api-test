import { AppSystemProp, ContainerType, PiecesSource, SystemProp, WorkerSystemProp } from 'automation-server-shared-test'
import { ApEdition, ApEnvironment, ExecutionMode, FileLocation, isNil, PieceSyncMode } from 'automation-shared-test'
