...
import { AiOverageState, ApEdition, ApEnvironment, apId, Cursor, FlowStatus, PlatformUsage, SeekPage, UserStatus } from 'automation-shared-test'
...
type IncreaseProjectAIUsageParams = {
    ...
    model: string
    cost: number
    metadata: commonai.AIUsageMetadata
}
...
type AICreditsUsageListResponse = Omit<commonai.AIUsage, 'cost'> & {
    credits: number
    projectName: string
}
