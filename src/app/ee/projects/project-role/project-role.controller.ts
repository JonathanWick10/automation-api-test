import { ApplicationEventName, ProjectMemberWithUser } from 'automation-ee-shared-test'
import { ApId, CreateProjectRoleRequestBody, ListProjectMembersForProjectRoleRequestQuery, Permission, PrincipalType, ProjectRole, SeekPage, SERVICE_KEY_SECURITY_OPENAPI, UpdateProjectRoleRequestBody } from 'automation-shared-test'
